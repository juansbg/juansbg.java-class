...
public abstract class ObjetoJuego {
  ...
  * por ejemplo: getImagen(ObjetoJuego.IM3)*/
  ...
  /**Contructor por excelencia que sera heredado por todos los objetos del juego.
    *@param dirImagen1 Sera un URL con el path de la Primera imagen del objeto.
    *@param dirImagen2 Sera un URL con el path de la Segunda imagen del objeto.
    *@param dirImagen3 Sera un URL con el path de la Tercera imagen del objeto.
  */
